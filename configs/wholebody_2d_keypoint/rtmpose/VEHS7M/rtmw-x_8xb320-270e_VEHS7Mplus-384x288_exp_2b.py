...
data_root = '/home/ubuntu/'  # Veeru aws path
...
VEHS7M_train_ann_file = 'datasets/VEHS_7m/VEHS_6DCOCO_downsample20_keep1_train.json'
VEHS7M_val_ann_file = 'datasets/VEHS_7m/VEHS_6DCOCO_downsample20_keep1_validate.json'

# VEHS7M_train_ann_file = 'datasets/VEHS_7m/VEHS_6DCOCO_downsample20_keep1_small_train.json'
# VEHS7M_val_ann_file = 'datasets/VEHS_7m/VEHS_6DCOCO_downsample20_keep1_small_validate.json'
...
dataset_VHES7M = dict(
    ...
    data_prefix=dict(img='datasets/VEHS_7m/5fps/train/'),
    pipeline=[],
)
...
dataset_aic = dict(
    type='AicDataset',
    data_root=data_root+"datasets/OpenDataLab___AI_Challenger/",
    data_mode=data_mode,
...
dataset_mpiitrb = dict(
    type='MpiiTrbDataset',
    data_root=data_root+"datasets/OpenDataLab___MPII_Human_Pose/",
    data_mode=data_mode,
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='datasets/VEHS_7m/5fps/validate/'),
...
# hooks
default_hooks = dict(
    checkpoint=dict(save_best='coco/AP', rule='greater', max_keep_ckpts=-1, interval=3))
